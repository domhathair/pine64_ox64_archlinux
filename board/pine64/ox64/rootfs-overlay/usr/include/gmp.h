...
#define __GMP_CC "gcc"
#define __GMP_CFLAGS "-march=rv64gc -mabi=lp64d -O2 -pipe -fno-plt -fexceptions         -Wp,-D_FORTIFY_SOURCE=2 -Wformat -Werror=format-security         -fstack-clash-protection -g -ffile-prefix-map=/build/gmp/src=/usr/src/debug/gmp -flto=auto"
